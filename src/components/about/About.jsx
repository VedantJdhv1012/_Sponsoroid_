      ...
      <section className='about'>
        ...
        <div className='container flex mtop'>
          <div className='left row'>
            ...
            <p><li> Tailored Matches: Our intelligent matching system ensures that creators and brands find the perfect fit for their collaboration needs.</li> 
            ...
            <li> Commitment to Security: We prioritize the privacy and security of our users, ensuring that all interactions are protected and confidential.</li> </p>
